...
namespace ASD.Areas.Dhasbord.Controllers
{
    [Authorize]
    [Area("Dhasbord")]
    public class SuperClienteNoOrdenTrabajoController : Controller
    {
        private readonly ILogger<SuperClienteNoOrdenTrabajoController> _logger;
        ...
        public SuperClienteNoOrdenTrabajoController(ILogger<SuperClienteNoOrdenTrabajoController> logger, IDPrioridadRepository dPrioridadRepository, IDPendientesRepository dPendientesRepository, ITicketRepository ticketRepository, ICat_EstatusTicketRepository cat_EstatusTicketRepository, IDTicketRepository dticketRepository,

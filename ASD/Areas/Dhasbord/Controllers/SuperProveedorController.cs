...
namespace ASD.Areas.Dhasbord.Controllers
{
    [Authorize]
    [Area("Dhasbord")]
    public class SuperProveedorController : Controller
    {
        private readonly ILogger<SuperProveedorController> _logger;
        ...
        public SuperProveedorController(ILogger<SuperProveedorController> logger, IDPrioridadRepository dPrioridadRepository, IDPendientesRepository dPendientesRepository, ITicketRepository ticketRepository, ICat_EstatusTicketRepository cat_EstatusTicketRepository, IDTicketRepository dticketRepository,

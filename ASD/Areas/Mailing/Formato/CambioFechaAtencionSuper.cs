...
{
    public class CambioFechaAtencionSuper
    {
        public string HtmlCambioFechaAtencionSuper(EmailViewModel email, CTicketViewModel db_ticket, CNuevaFechaAtencionViewModel cNuevaFechaAtencion)
        {
            string redult = $@"

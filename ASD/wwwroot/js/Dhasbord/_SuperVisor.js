...
function ConsultarOperacion() {
    window.location.href = '/Ticket/Ticket/Operacion';
}
...
function ConsultarTicket(Id) {
    alert(1);
    window.location.href = '/Ticket/Ticket/Detalle?cont=' + Id;
}
...
function ContaEstado(IdEstado) {
    window.location.href = '/Ticket/Ticket/TicketEstado?cont=' + IdEstado;
}
